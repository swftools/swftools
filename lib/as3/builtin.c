...
static constant_t flash_utils_flash_proxy_constant = {type: 8, ns: &flash_utils_flash_proxy_constant_ns};
...
static constant_t _AS3_constant = {type: 8, ns: &_AS3_constant_ns};
