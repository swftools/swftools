...
static memberinfo_t flash_accessibility_AccessibilityImplementation_errno = {MEMBER_SLOT, 0x01, "errno", 0, &flash_accessibility_AccessibilityImplementation};
static memberinfo_t flash_accessibility_AccessibilityImplementation_accDoDefaultAction = {MEMBER_METHOD, 0x01, "accDoDefaultAction", 0, &flash_accessibility_AccessibilityImplementation};
static memberinfo_t flash_accessibility_AccessibilityImplementation_get_accRole = {MEMBER_METHOD, 0x01, "get_accRole", &_uint, &flash_accessibility_AccessibilityImplementation};
static memberinfo_t flash_accessibility_AccessibilityImplementation_getChildIDArray = {MEMBER_METHOD, 0x01, "getChildIDArray", &_Array, &flash_accessibility_AccessibilityImplementation};
static memberinfo_t flash_accessibility_AccessibilityImplementation_get_accSelection = {MEMBER_METHOD, 0x01, "get_accSelection", &_Array, &flash_accessibility_AccessibilityImplementation};
static memberinfo_t flash_accessibility_AccessibilityImplementation_stub = {MEMBER_SLOT, 0x01, "stub", 0, &flash_accessibility_AccessibilityImplementation};
static memberinfo_t flash_accessibility_AccessibilityImplementation_accLocation = {MEMBER_METHOD, 0x01, "accLocation", 0, &flash_accessibility_AccessibilityImplementation};
static memberinfo_t flash_accessibility_AccessibilityImplementation_isLabeledBy = {MEMBER_METHOD, 0x01, "isLabeledBy", &_Boolean, &flash_accessibility_AccessibilityImplementation};
...
static memberinfo_t flash_display_BitmapData_width = {MEMBER_SLOT, 0x01, "width", 0, &flash_display_BitmapData};
static memberinfo_t flash_display_BitmapData_colorTransform = {MEMBER_METHOD, 0x01, "colorTransform", 0, &flash_display_BitmapData};
static memberinfo_t flash_display_BitmapData_draw = {MEMBER_METHOD, 0x01, "draw", 0, &flash_display_BitmapData};
static memberinfo_t flash_display_BitmapData_applyFilter = {MEMBER_METHOD, 0x01, "applyFilter", 0, &flash_display_BitmapData};
static memberinfo_t flash_display_BitmapData_fillRect = {MEMBER_METHOD, 0x01, "fillRect", 0, &flash_display_BitmapData};
static memberinfo_t flash_display_BitmapData_getPixel = {MEMBER_METHOD, 0x01, "getPixel", &_uint, &flash_display_BitmapData};
static memberinfo_t flash_display_BitmapData_generateFilterRect = {MEMBER_METHOD, 0x01, "generateFilterRect", &flash_geom_Rectangle, &flash_display_BitmapData};
static memberinfo_t flash_display_BitmapData_transparent = {MEMBER_SLOT, 0x01, "transparent", 0, &flash_display_BitmapData};
static memberinfo_t flash_display_BitmapData_unlock = {MEMBER_METHOD, 0x01, "unlock", 0, &flash_display_BitmapData};
static memberinfo_t flash_display_BitmapData_scroll = {MEMBER_METHOD, 0x01, "scroll", 0, &flash_display_BitmapData};
static memberinfo_t flash_display_BitmapData_copyChannel = {MEMBER_METHOD, 0x01, "copyChannel", 0, &flash_display_BitmapData};
static memberinfo_t flash_display_BitmapData_pixelDissolve = {MEMBER_METHOD, 0x01, "pixelDissolve", &_int, &flash_display_BitmapData};
static memberinfo_t flash_display_BitmapData_noise = {MEMBER_METHOD, 0x01, "noise", 0, &flash_display_BitmapData};
static memberinfo_t flash_display_BitmapData_clone = {MEMBER_METHOD, 0x01, "clone", &flash_display_BitmapData, &flash_display_BitmapData};
static memberinfo_t flash_display_BitmapData_getColorBoundsRect = {MEMBER_METHOD, 0x01, "getColorBoundsRect", &flash_geom_Rectangle, &flash_display_BitmapData};
static memberinfo_t flash_display_BitmapData_dispose = {MEMBER_METHOD, 0x01, "dispose", 0, &flash_display_BitmapData};
static memberinfo_t flash_display_BitmapData_floodFill = {MEMBER_METHOD, 0x01, "floodFill", 0, &flash_display_BitmapData};
static memberinfo_t flash_display_BitmapData_setPixel32 = {MEMBER_METHOD, 0x01, "setPixel32", 0, &flash_display_BitmapData};
static memberinfo_t flash_display_BitmapData_rect = {MEMBER_SLOT, 0x01, "rect", 0, &flash_display_BitmapData};
static memberinfo_t flash_display_BitmapData_compare = {MEMBER_METHOD, 0x01, "compare", &_Object, &flash_display_BitmapData};
static memberinfo_t flash_display_BitmapData_perlinNoise = {MEMBER_METHOD, 0x01, "perlinNoise", 0, &flash_display_BitmapData};
static memberinfo_t flash_display_BitmapData_height = {MEMBER_SLOT, 0x01, "height", 0, &flash_display_BitmapData};
static memberinfo_t flash_display_BitmapData_paletteMap = {MEMBER_METHOD, 0x01, "paletteMap", 0, &flash_display_BitmapData};
static memberinfo_t flash_display_BitmapData_getPixels = {MEMBER_METHOD, 0x01, "getPixels", &flash_utils_ByteArray, &flash_display_BitmapData};
static memberinfo_t flash_display_BitmapData_threshold = {MEMBER_METHOD, 0x01, "threshold", &_uint, &flash_display_BitmapData};
static memberinfo_t flash_display_BitmapData_getPixel32 = {MEMBER_METHOD, 0x01, "getPixel32", &_uint, &flash_display_BitmapData};
...
static memberinfo_t flash_display_DisplayObject_localToGlobal = {MEMBER_METHOD, 0x01, "localToGlobal", &flash_geom_Point, &flash_display_DisplayObject};
static memberinfo_t flash_display_DisplayObject_name = {MEMBER_SLOT, 0x01, "name", 0, &flash_display_DisplayObject};
static memberinfo_t flash_display_DisplayObject_width = {MEMBER_SLOT, 0x01, "width", 0, &flash_display_DisplayObject};
static memberinfo_t flash_display_DisplayObject_blendMode = {MEMBER_SLOT, 0x01, "blendMode", 0, &flash_display_DisplayObject};
static memberinfo_t flash_display_DisplayObject_scale9Grid = {MEMBER_SLOT, 0x01, "scale9Grid", 0, &flash_display_DisplayObject};
static memberinfo_t flash_display_DisplayObject_scaleX = {MEMBER_SLOT, 0x01, "scaleX", 0, &flash_display_DisplayObject};
static memberinfo_t flash_display_DisplayObject_scaleY = {MEMBER_SLOT, 0x01, "scaleY", 0, &flash_display_DisplayObject};
static memberinfo_t flash_display_DisplayObject_accessibilityProperties = {MEMBER_SLOT, 0x01, "accessibilityProperties", 0, &flash_display_DisplayObject};
static memberinfo_t flash_display_DisplayObject_scrollRect = {MEMBER_SLOT, 0x01, "scrollRect", 0, &flash_display_DisplayObject};
static memberinfo_t flash_display_DisplayObject_cacheAsBitmap = {MEMBER_SLOT, 0x01, "cacheAsBitmap", 0, &flash_display_DisplayObject};
static memberinfo_t flash_display_DisplayObject_globalToLocal = {MEMBER_METHOD, 0x01, "globalToLocal", &flash_geom_Point, &flash_display_DisplayObject};
static memberinfo_t flash_display_DisplayObject_height = {MEMBER_SLOT, 0x01, "height", 0, &flash_display_DisplayObject};
static memberinfo_t flash_display_DisplayObject_parent = {MEMBER_SLOT, 0x01, "parent", 0, &flash_display_DisplayObject};
static memberinfo_t flash_display_DisplayObject_getBounds = {MEMBER_METHOD, 0x01, "getBounds", &flash_geom_Rectangle, &flash_display_DisplayObject};
static memberinfo_t flash_display_DisplayObject_opaqueBackground = {MEMBER_SLOT, 0x01, "opaqueBackground", 0, &flash_display_DisplayObject};
static memberinfo_t flash_display_DisplayObject_alpha = {MEMBER_SLOT, 0x01, "alpha", 0, &flash_display_DisplayObject};
static memberinfo_t flash_display_DisplayObject_hitTestPoint = {MEMBER_METHOD, 0x01, "hitTestPoint", &_Boolean, &flash_display_DisplayObject};
static memberinfo_t flash_display_DisplayObject_mouseX = {MEMBER_SLOT, 0x01, "mouseX", 0, &flash_display_DisplayObject};
static memberinfo_t flash_display_DisplayObject_mask = {MEMBER_SLOT, 0x01, "mask", 0, &flash_display_DisplayObject};
static memberinfo_t flash_display_DisplayObject_getRect = {MEMBER_METHOD, 0x01, "getRect", &flash_geom_Rectangle, &flash_display_DisplayObject};
static memberinfo_t flash_display_DisplayObject_mouseY = {MEMBER_SLOT, 0x01, "mouseY", 0, &flash_display_DisplayObject};
static memberinfo_t flash_display_DisplayObject_loaderInfo = {MEMBER_SLOT, 0x01, "loaderInfo", 0, &flash_display_DisplayObject};
static memberinfo_t flash_display_DisplayObject_root = {MEMBER_SLOT, 0x01, "root", 0, &flash_display_DisplayObject};
static memberinfo_t flash_display_DisplayObject_visible = {MEMBER_SLOT, 0x01, "visible", 0, &flash_display_DisplayObject};
static memberinfo_t flash_display_DisplayObject_hitTestObject = {MEMBER_METHOD, 0x01, "hitTestObject", &_Boolean, &flash_display_DisplayObject};
...
static memberinfo_t flash_display_DisplayObjectContainer_getChildIndex = {MEMBER_METHOD, 0x01, "getChildIndex", &_int, &flash_display_DisplayObjectContainer};
static memberinfo_t flash_display_DisplayObjectContainer_mouseChildren = {MEMBER_SLOT, 0x01, "mouseChildren", 0, &flash_display_DisplayObjectContainer};
static memberinfo_t flash_display_DisplayObjectContainer_setChildIndex = {MEMBER_METHOD, 0x01, "setChildIndex", 0, &flash_display_DisplayObjectContainer};
static memberinfo_t flash_display_DisplayObjectContainer_addChildAt = {MEMBER_METHOD, 0x01, "addChildAt", &flash_display_DisplayObject, &flash_display_DisplayObjectContainer};
static memberinfo_t flash_display_DisplayObjectContainer_contains = {MEMBER_METHOD, 0x01, "contains", &_Boolean, &flash_display_DisplayObjectContainer};
static memberinfo_t flash_display_DisplayObjectContainer_numChildren = {MEMBER_SLOT, 0x01, "numChildren", 0, &flash_display_DisplayObjectContainer};
static memberinfo_t flash_display_DisplayObjectContainer_swapChildrenAt = {MEMBER_METHOD, 0x01, "swapChildrenAt", 0, &flash_display_DisplayObjectContainer};
static memberinfo_t flash_display_DisplayObjectContainer_tabChildren = {MEMBER_SLOT, 0x01, "tabChildren", 0, &flash_display_DisplayObjectContainer};
static memberinfo_t flash_display_DisplayObjectContainer_getChildAt = {MEMBER_METHOD, 0x01, "getChildAt", &flash_display_DisplayObject, &flash_display_DisplayObjectContainer};
static memberinfo_t flash_display_DisplayObjectContainer_swapChildren = {MEMBER_METHOD, 0x01, "swapChildren", 0, &flash_display_DisplayObjectContainer};
static memberinfo_t flash_display_DisplayObjectContainer_getObjectsUnderPoint = {MEMBER_METHOD, 0x01, "getObjectsUnderPoint", &_Array, &flash_display_DisplayObjectContainer};
...
static memberinfo_t flash_display_Graphics_curveTo = {MEMBER_METHOD, 0x01, "curveTo", 0, &flash_display_Graphics};
static memberinfo_t flash_display_Graphics_beginFill = {MEMBER_METHOD, 0x01, "beginFill", 0, &flash_display_Graphics};
static memberinfo_t flash_display_Graphics_lineGradientStyle = {MEMBER_METHOD, 0x01, "lineGradientStyle", 0, &flash_display_Graphics};
static memberinfo_t flash_display_Graphics_drawRoundRect = {MEMBER_METHOD, 0x01, "drawRoundRect", 0, &flash_display_Graphics};
static memberinfo_t flash_display_Graphics_moveTo = {MEMBER_METHOD, 0x01, "moveTo", 0, &flash_display_Graphics};
static memberinfo_t flash_display_Graphics_clear = {MEMBER_METHOD, 0x01, "clear", 0, &flash_display_Graphics};
static memberinfo_t flash_display_Graphics_lineTo = {MEMBER_METHOD, 0x01, "lineTo", 0, &flash_display_Graphics};
static memberinfo_t flash_display_Graphics_drawEllipse = {MEMBER_METHOD, 0x01, "drawEllipse", 0, &flash_display_Graphics};
static memberinfo_t flash_display_Graphics_beginBitmapFill = {MEMBER_METHOD, 0x01, "beginBitmapFill", 0, &flash_display_Graphics};
...
static memberinfo_t flash_display_InteractiveObject_accessibilityImplementation = {MEMBER_SLOT, 0x01, "accessibilityImplementation", 0, &flash_display_InteractiveObject};
...
static memberinfo_t flash_display_Loader_loadBytes = {MEMBER_METHOD, 0x01, "loadBytes", 0, &flash_display_Loader};
static memberinfo_t flash_display_Loader_removeChildAt = {MEMBER_METHOD, 0x01, "removeChildAt", &flash_display_DisplayObject, &flash_display_Loader};
static memberinfo_t flash_display_Loader_content = {MEMBER_SLOT, 0x01, "content", 0, &flash_display_Loader};
static memberinfo_t flash_display_Loader_addChildAt = {MEMBER_METHOD, 0x01, "addChildAt", &flash_display_DisplayObject, &flash_display_Loader};
static memberinfo_t flash_display_Loader_contentLoaderInfo = {MEMBER_SLOT, 0x01, "contentLoaderInfo", 0, &flash_display_Loader};
...
static memberinfo_t flash_display_LoaderInfo_childAllowsParent = {MEMBER_SLOT, 0x01, "childAllowsParent", 0, &flash_display_LoaderInfo};
static memberinfo_t flash_display_LoaderInfo_bytesTotal = {MEMBER_SLOT, 0x01, "bytesTotal", 0, &flash_display_LoaderInfo};
static memberinfo_t flash_display_LoaderInfo_loader = {MEMBER_SLOT, 0x01, "loader", 0, &flash_display_LoaderInfo};
static memberinfo_t flash_display_LoaderInfo_loaderURL = {MEMBER_SLOT, 0x01, "loaderURL", 0, &flash_display_LoaderInfo};
static memberinfo_t flash_display_LoaderInfo_width = {MEMBER_SLOT, 0x01, "width", 0, &flash_display_LoaderInfo};
static memberinfo_t flash_display_LoaderInfo_sameDomain = {MEMBER_SLOT, 0x01, "sameDomain", 0, &flash_display_LoaderInfo};
static memberinfo_t flash_display_LoaderInfo_sharedEvents = {MEMBER_SLOT, 0x01, "sharedEvents", 0, &flash_display_LoaderInfo};
static memberinfo_t flash_display_LoaderInfo_height = {MEMBER_SLOT, 0x01, "height", 0, &flash_display_LoaderInfo};
static memberinfo_t flash_display_LoaderInfo_parentAllowsChild = {MEMBER_SLOT, 0x01, "parentAllowsChild", 0, &flash_display_LoaderInfo};
static memberinfo_t flash_display_LoaderInfo_parameters = {MEMBER_SLOT, 0x01, "parameters", 0, &flash_display_LoaderInfo};
static memberinfo_t flash_display_LoaderInfo_frameRate = {MEMBER_SLOT, 0x01, "frameRate", 0, &flash_display_LoaderInfo};
static memberinfo_t flash_display_LoaderInfo_url = {MEMBER_SLOT, 0x01, "url", 0, &flash_display_LoaderInfo};
static memberinfo_t flash_display_LoaderInfo_swfVersion = {MEMBER_SLOT, 0x01, "swfVersion", 0, &flash_display_LoaderInfo};
...
static memberinfo_t flash_display_MovieClip_totalFrames = {MEMBER_SLOT, 0x01, "totalFrames", 0, &flash_display_MovieClip};
static memberinfo_t flash_display_MovieClip_prevScene = {MEMBER_METHOD, 0x01, "prevScene", 0, &flash_display_MovieClip};
static memberinfo_t flash_display_MovieClip_play = {MEMBER_METHOD, 0x01, "play", 0, &flash_display_MovieClip};
static memberinfo_t flash_display_MovieClip_addFrameScript = {MEMBER_METHOD, 0x01, "addFrameScript", 0, &flash_display_MovieClip};
static memberinfo_t flash_display_MovieClip_nextFrame = {MEMBER_METHOD, 0x01, "nextFrame", 0, &flash_display_MovieClip};
static memberinfo_t flash_display_MovieClip_enabled = {MEMBER_SLOT, 0x01, "enabled", 0, &flash_display_MovieClip};
static memberinfo_t flash_display_MovieClip_framesLoaded = {MEMBER_SLOT, 0x01, "framesLoaded", 0, &flash_display_MovieClip};
static memberinfo_t flash_display_MovieClip_scenes = {MEMBER_SLOT, 0x01, "scenes", 0, &flash_display_MovieClip};
static memberinfo_t flash_display_MovieClip_nextScene = {MEMBER_METHOD, 0x01, "nextScene", 0, &flash_display_MovieClip};
static memberinfo_t flash_display_MovieClip_currentFrame = {MEMBER_SLOT, 0x01, "currentFrame", 0, &flash_display_MovieClip};
static memberinfo_t flash_display_MovieClip_gotoAndStop = {MEMBER_METHOD, 0x01, "gotoAndStop", 0, &flash_display_MovieClip};
static memberinfo_t flash_display_MovieClip_currentScene = {MEMBER_SLOT, 0x01, "currentScene", 0, &flash_display_MovieClip};
...
static memberinfo_t flash_display_SimpleButton_soundTransform = {MEMBER_SLOT, 0x01, "soundTransform", 0, &flash_display_SimpleButton};
static memberinfo_t flash_display_SimpleButton_downState = {MEMBER_SLOT, 0x01, "downState", 0, &flash_display_SimpleButton};
...
static memberinfo_t flash_display_Sprite_dropTarget = {MEMBER_SLOT, 0x01, "dropTarget", 0, &flash_display_Sprite};
static memberinfo_t flash_display_Sprite_hitArea = {MEMBER_SLOT, 0x01, "hitArea", 0, &flash_display_Sprite};
...
static memberinfo_t flash_display_Stage_scaleMode = {MEMBER_SLOT, 0x01, "scaleMode", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_textSnapshot = {MEMBER_SLOT, 0x01, "textSnapshot", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_name = {MEMBER_SLOT, 0x01, "name", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_setChildIndex = {MEMBER_METHOD, 0x01, "setChildIndex", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_showDefaultContextMenu = {MEMBER_SLOT, 0x01, "showDefaultContextMenu", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_quality = {MEMBER_SLOT, 0x01, "quality", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_height = {MEMBER_SLOT, 0x01, "height", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_blendMode = {MEMBER_SLOT, 0x01, "blendMode", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_scale9Grid = {MEMBER_SLOT, 0x01, "scale9Grid", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_invalidate = {MEMBER_METHOD, 0x01, "invalidate", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_accessibilityImplementation = {MEMBER_SLOT, 0x01, "accessibilityImplementation", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_accessibilityProperties = {MEMBER_SLOT, 0x01, "accessibilityProperties", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_cacheAsBitmap = {MEMBER_SLOT, 0x01, "cacheAsBitmap", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_dispatchEvent = {MEMBER_METHOD, 0x01, "dispatchEvent", &_Boolean, &flash_display_Stage};
static memberinfo_t flash_display_Stage_removeChildAt = {MEMBER_METHOD, 0x01, "removeChildAt", &flash_display_DisplayObject, &flash_display_Stage};
static memberinfo_t flash_display_Stage_addEventListener = {MEMBER_METHOD, 0x01, "addEventListener", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_contextMenu = {MEMBER_SLOT, 0x01, "contextMenu", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_opaqueBackground = {MEMBER_SLOT, 0x01, "opaqueBackground", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_tabChildren = {MEMBER_SLOT, 0x01, "tabChildren", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_stageWidth = {MEMBER_SLOT, 0x01, "stageWidth", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_tabIndex = {MEMBER_SLOT, 0x01, "tabIndex", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_swapChildrenAt = {MEMBER_METHOD, 0x01, "swapChildrenAt", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_stageHeight = {MEMBER_SLOT, 0x01, "stageHeight", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_width = {MEMBER_SLOT, 0x01, "width", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_willTrigger = {MEMBER_METHOD, 0x01, "willTrigger", &_Boolean, &flash_display_Stage};
static memberinfo_t flash_display_Stage_addChildAt = {MEMBER_METHOD, 0x01, "addChildAt", &flash_display_DisplayObject, &flash_display_Stage};
static memberinfo_t flash_display_Stage_mouseChildren = {MEMBER_SLOT, 0x01, "mouseChildren", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_isFocusInaccessible = {MEMBER_METHOD, 0x01, "isFocusInaccessible", &_Boolean, &flash_display_Stage};
static memberinfo_t flash_display_Stage_scaleX = {MEMBER_SLOT, 0x01, "scaleX", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_scaleY = {MEMBER_SLOT, 0x01, "scaleY", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_scrollRect = {MEMBER_SLOT, 0x01, "scrollRect", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_numChildren = {MEMBER_SLOT, 0x01, "numChildren", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_focus = {MEMBER_SLOT, 0x01, "focus", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_focusRect = {MEMBER_SLOT, 0x01, "focusRect", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_alpha = {MEMBER_SLOT, 0x01, "alpha", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_mouseEnabled = {MEMBER_SLOT, 0x01, "mouseEnabled", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_mask = {MEMBER_SLOT, 0x01, "mask", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_frameRate = {MEMBER_SLOT, 0x01, "frameRate", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_transform = {MEMBER_SLOT, 0x01, "transform", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_visible = {MEMBER_SLOT, 0x01, "visible", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_tabEnabled = {MEMBER_SLOT, 0x01, "tabEnabled", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_x = {MEMBER_SLOT, 0x01, "x", 0, &flash_display_Stage};
static memberinfo_t flash_display_Stage_y = {MEMBER_SLOT, 0x01, "y", 0, &flash_display_Stage};
...
static memberinfo_t flash_events_Event_eventPhase = {MEMBER_SLOT, 0x01, "eventPhase", 0, &flash_events_Event};
static memberinfo_t flash_events_Event_preventDefault = {MEMBER_METHOD, 0x01, "preventDefault", 0, &flash_events_Event};
static memberinfo_t flash_events_Event_currentTarget = {MEMBER_SLOT, 0x01, "currentTarget", 0, &flash_events_Event};
static memberinfo_t flash_events_Event_toString = {MEMBER_METHOD, 0x01, "toString", &_String, &flash_events_Event};
static memberinfo_t flash_events_Event_bubbles = {MEMBER_SLOT, 0x01, "bubbles", 0, &flash_events_Event};
static memberinfo_t flash_events_Event_target = {MEMBER_SLOT, 0x01, "target", 0, &flash_events_Event};
static memberinfo_t flash_events_Event_cancelable = {MEMBER_SLOT, 0x01, "cancelable", 0, &flash_events_Event};
...
static memberinfo_t flash_events_KeyboardEvent_shiftKey = {MEMBER_SLOT, 0x01, "shiftKey", 0, &flash_events_KeyboardEvent};
static memberinfo_t flash_events_KeyboardEvent_keyCode = {MEMBER_SLOT, 0x01, "keyCode", 0, &flash_events_KeyboardEvent};
static memberinfo_t flash_events_KeyboardEvent_clone = {MEMBER_METHOD, 0x01, "clone", &flash_events_Event, &flash_events_KeyboardEvent};
...
static memberinfo_t flash_events_MouseEvent_localY = {MEMBER_SLOT, 0x01, "localY", 0, &flash_events_MouseEvent};
static memberinfo_t flash_events_MouseEvent_stageX = {MEMBER_SLOT, 0x01, "stageX", 0, &flash_events_MouseEvent};
static memberinfo_t flash_events_MouseEvent_delta = {MEMBER_SLOT, 0x01, "delta", 0, &flash_events_MouseEvent};
static memberinfo_t flash_events_MouseEvent_updateAfterEvent = {MEMBER_METHOD, 0x01, "updateAfterEvent", 0, &flash_events_MouseEvent};
static memberinfo_t flash_events_MouseEvent_clone = {MEMBER_METHOD, 0x01, "clone", &flash_events_Event, &flash_events_MouseEvent};
static memberinfo_t flash_events_MouseEvent_ctrlKey = {MEMBER_SLOT, 0x01, "ctrlKey", 0, &flash_events_MouseEvent};
static memberinfo_t flash_events_MouseEvent_toString = {MEMBER_METHOD, 0x01, "toString", &_String, &flash_events_MouseEvent};
...
static memberinfo_t flash_filters_BevelFilter_highlightAlpha = {MEMBER_SLOT, 0x01, "highlightAlpha", 0, &flash_filters_BevelFilter};
static memberinfo_t flash_filters_BevelFilter_highlightColor = {MEMBER_SLOT, 0x01, "highlightColor", 0, &flash_filters_BevelFilter};
static memberinfo_t flash_filters_BevelFilter_blurX = {MEMBER_SLOT, 0x01, "blurX", 0, &flash_filters_BevelFilter};
static memberinfo_t flash_filters_BevelFilter_blurY = {MEMBER_SLOT, 0x01, "blurY", 0, &flash_filters_BevelFilter};
static memberinfo_t flash_filters_BevelFilter_angle = {MEMBER_SLOT, 0x01, "angle", 0, &flash_filters_BevelFilter};
static memberinfo_t flash_filters_BevelFilter_clone = {MEMBER_METHOD, 0x01, "clone", &flash_filters_BitmapFilter, &flash_filters_BevelFilter};
static memberinfo_t flash_filters_BevelFilter_shadowAlpha = {MEMBER_SLOT, 0x01, "shadowAlpha", 0, &flash_filters_BevelFilter};
...
static memberinfo_t flash_filters_ConvolutionFilter_alpha = {MEMBER_SLOT, 0x01, "alpha", 0, &flash_filters_ConvolutionFilter};
static memberinfo_t flash_filters_ConvolutionFilter_matrixX = {MEMBER_SLOT, 0x01, "matrixX", 0, &flash_filters_ConvolutionFilter};
static memberinfo_t flash_filters_ConvolutionFilter_matrixY = {MEMBER_SLOT, 0x01, "matrixY", 0, &flash_filters_ConvolutionFilter};
static memberinfo_t flash_filters_ConvolutionFilter_bias = {MEMBER_SLOT, 0x01, "bias", 0, &flash_filters_ConvolutionFilter};
...
static memberinfo_t flash_filters_DisplacementMapFilter_scaleY = {MEMBER_SLOT, 0x01, "scaleY", 0, &flash_filters_DisplacementMapFilter};
static memberinfo_t flash_filters_DisplacementMapFilter_mode = {MEMBER_SLOT, 0x01, "mode", 0, &flash_filters_DisplacementMapFilter};
static memberinfo_t flash_filters_DisplacementMapFilter_mapPoint = {MEMBER_SLOT, 0x01, "mapPoint", 0, &flash_filters_DisplacementMapFilter};
static memberinfo_t flash_filters_DisplacementMapFilter_mapBitmap = {MEMBER_SLOT, 0x01, "mapBitmap", 0, &flash_filters_DisplacementMapFilter};
...
static memberinfo_t flash_filters_DropShadowFilter_blurX = {MEMBER_SLOT, 0x01, "blurX", 0, &flash_filters_DropShadowFilter};
static memberinfo_t flash_filters_DropShadowFilter_blurY = {MEMBER_SLOT, 0x01, "blurY", 0, &flash_filters_DropShadowFilter};
static memberinfo_t flash_filters_DropShadowFilter_angle = {MEMBER_SLOT, 0x01, "angle", 0, &flash_filters_DropShadowFilter};
static memberinfo_t flash_filters_DropShadowFilter_inner = {MEMBER_SLOT, 0x01, "inner", 0, &flash_filters_DropShadowFilter};
static memberinfo_t flash_filters_DropShadowFilter_clone = {MEMBER_METHOD, 0x01, "clone", &flash_filters_BitmapFilter, &flash_filters_DropShadowFilter};
static memberinfo_t flash_filters_DropShadowFilter_alpha = {MEMBER_SLOT, 0x01, "alpha", 0, &flash_filters_DropShadowFilter};
...
static memberinfo_t flash_filters_GlowFilter_quality = {MEMBER_SLOT, 0x01, "quality", 0, &flash_filters_GlowFilter};
static memberinfo_t flash_filters_GlowFilter_strength = {MEMBER_SLOT, 0x01, "strength", 0, &flash_filters_GlowFilter};
static memberinfo_t flash_filters_GlowFilter_inner = {MEMBER_SLOT, 0x01, "inner", 0, &flash_filters_GlowFilter};
...
static memberinfo_t flash_filters_GradientBevelFilter_blurX = {MEMBER_SLOT, 0x01, "blurX", 0, &flash_filters_GradientBevelFilter};
static memberinfo_t flash_filters_GradientBevelFilter_blurY = {MEMBER_SLOT, 0x01, "blurY", 0, &flash_filters_GradientBevelFilter};
static memberinfo_t flash_filters_GradientBevelFilter_angle = {MEMBER_SLOT, 0x01, "angle", 0, &flash_filters_GradientBevelFilter};
static memberinfo_t flash_filters_GradientBevelFilter_alphas = {MEMBER_SLOT, 0x01, "alphas", 0, &flash_filters_GradientBevelFilter};
static memberinfo_t flash_filters_GradientBevelFilter_clone = {MEMBER_METHOD, 0x01, "clone", &flash_filters_BitmapFilter, &flash_filters_GradientBevelFilter};
static memberinfo_t flash_filters_GradientBevelFilter_colors = {MEMBER_SLOT, 0x01, "colors", 0, &flash_filters_GradientBevelFilter};
...
static memberinfo_t flash_filters_GradientGlowFilter_blurX = {MEMBER_SLOT, 0x01, "blurX", 0, &flash_filters_GradientGlowFilter};
static memberinfo_t flash_filters_GradientGlowFilter_blurY = {MEMBER_SLOT, 0x01, "blurY", 0, &flash_filters_GradientGlowFilter};
static memberinfo_t flash_filters_GradientGlowFilter_angle = {MEMBER_SLOT, 0x01, "angle", 0, &flash_filters_GradientGlowFilter};
static memberinfo_t flash_filters_GradientGlowFilter_alphas = {MEMBER_SLOT, 0x01, "alphas", 0, &flash_filters_GradientGlowFilter};
static memberinfo_t flash_filters_GradientGlowFilter_clone = {MEMBER_METHOD, 0x01, "clone", &flash_filters_BitmapFilter, &flash_filters_GradientGlowFilter};
static memberinfo_t flash_filters_GradientGlowFilter_colors = {MEMBER_SLOT, 0x01, "colors", 0, &flash_filters_GradientGlowFilter};
...
static memberinfo_t flash_geom_ColorTransform_blueOffset = {MEMBER_SLOT, 0x01, "blueOffset", 0, &flash_geom_ColorTransform};
static memberinfo_t flash_geom_ColorTransform_toString = {MEMBER_METHOD, 0x01, "toString", &_String, &flash_geom_ColorTransform};
static memberinfo_t flash_geom_ColorTransform_alphaOffset = {MEMBER_SLOT, 0x01, "alphaOffset", 0, &flash_geom_ColorTransform};
static memberinfo_t flash_geom_ColorTransform_redMultiplier = {MEMBER_SLOT, 0x01, "redMultiplier", 0, &flash_geom_ColorTransform};
static memberinfo_t flash_geom_ColorTransform_concat = {MEMBER_METHOD, 0x01, "concat", 0, &flash_geom_ColorTransform};
...
static memberinfo_t flash_geom_Matrix_scale = {MEMBER_METHOD, 0x01, "scale", 0, &flash_geom_Matrix};
static memberinfo_t flash_geom_Matrix_transformPoint = {MEMBER_METHOD, 0x01, "transformPoint", &flash_geom_Point, &flash_geom_Matrix};
static memberinfo_t flash_geom_Matrix_concat = {MEMBER_METHOD, 0x01, "concat", 0, &flash_geom_Matrix};
static memberinfo_t flash_geom_Matrix_invert = {MEMBER_METHOD, 0x01, "invert", 0, &flash_geom_Matrix};
static memberinfo_t flash_geom_Matrix_rotate = {MEMBER_METHOD, 0x01, "rotate", 0, &flash_geom_Matrix};
static memberinfo_t flash_geom_Matrix_deltaTransformPoint = {MEMBER_METHOD, 0x01, "deltaTransformPoint", &flash_geom_Point, &flash_geom_Matrix};
static memberinfo_t flash_geom_Matrix_clone = {MEMBER_METHOD, 0x01, "clone", &flash_geom_Matrix, &flash_geom_Matrix};
static memberinfo_t flash_geom_Matrix_createGradientBox = {MEMBER_METHOD, 0x01, "createGradientBox", 0, &flash_geom_Matrix};
static memberinfo_t flash_geom_Matrix_a = {MEMBER_SLOT, 0x01, "a", 0, &flash_geom_Matrix};
static memberinfo_t flash_geom_Matrix_b = {MEMBER_SLOT, 0x01, "b", 0, &flash_geom_Matrix};
static memberinfo_t flash_geom_Matrix_c = {MEMBER_SLOT, 0x01, "c", 0, &flash_geom_Matrix};
static memberinfo_t flash_geom_Matrix_d = {MEMBER_SLOT, 0x01, "d", 0, &flash_geom_Matrix};
...
static memberinfo_t flash_geom_Point_normalize = {MEMBER_METHOD, 0x01, "normalize", 0, &flash_geom_Point};
static memberinfo_t flash_geom_Point_subtract = {MEMBER_METHOD, 0x01, "subtract", &flash_geom_Point, &flash_geom_Point};
static memberinfo_t flash_geom_Point_x = {MEMBER_SLOT, 0x01, "x", 0, &flash_geom_Point};
static memberinfo_t flash_geom_Point_y = {MEMBER_SLOT, 0x01, "y", 0, &flash_geom_Point};
...
static memberinfo_t flash_geom_Rectangle_width = {MEMBER_SLOT, 0x01, "width", 0, &flash_geom_Rectangle};
static memberinfo_t flash_geom_Rectangle_left = {MEMBER_SLOT, 0x01, "left", 0, &flash_geom_Rectangle};
static memberinfo_t flash_geom_Rectangle_inflatePoint = {MEMBER_METHOD, 0x01, "inflatePoint", 0, &flash_geom_Rectangle};
static memberinfo_t flash_geom_Rectangle_setEmpty = {MEMBER_METHOD, 0x01, "setEmpty", 0, &flash_geom_Rectangle};
static memberinfo_t flash_geom_Rectangle_right = {MEMBER_SLOT, 0x01, "right", 0, &flash_geom_Rectangle};
static memberinfo_t flash_geom_Rectangle_offset = {MEMBER_METHOD, 0x01, "offset", 0, &flash_geom_Rectangle};
static memberinfo_t flash_geom_Rectangle_top = {MEMBER_SLOT, 0x01, "top", 0, &flash_geom_Rectangle};
static memberinfo_t flash_geom_Rectangle_equals = {MEMBER_METHOD, 0x01, "equals", &_Boolean, &flash_geom_Rectangle};
static memberinfo_t flash_geom_Rectangle_intersection = {MEMBER_METHOD, 0x01, "intersection", &flash_geom_Rectangle, &flash_geom_Rectangle};
static memberinfo_t flash_geom_Rectangle_union = {MEMBER_METHOD, 0x01, "union", &flash_geom_Rectangle, &flash_geom_Rectangle};
static memberinfo_t flash_geom_Rectangle_inflate = {MEMBER_METHOD, 0x01, "inflate", 0, &flash_geom_Rectangle};
static memberinfo_t flash_geom_Rectangle_bottomRight = {MEMBER_SLOT, 0x01, "bottomRight", 0, &flash_geom_Rectangle};
static memberinfo_t flash_geom_Rectangle_containsRect = {MEMBER_METHOD, 0x01, "containsRect", &_Boolean, &flash_geom_Rectangle};
static memberinfo_t flash_geom_Rectangle_clone = {MEMBER_METHOD, 0x01, "clone", &flash_geom_Rectangle, &flash_geom_Rectangle};
static memberinfo_t flash_geom_Rectangle_bottom = {MEMBER_SLOT, 0x01, "bottom", 0, &flash_geom_Rectangle};
static memberinfo_t flash_geom_Rectangle_contains = {MEMBER_METHOD, 0x01, "contains", &_Boolean, &flash_geom_Rectangle};
static memberinfo_t flash_geom_Rectangle_height = {MEMBER_SLOT, 0x01, "height", 0, &flash_geom_Rectangle};
static memberinfo_t flash_geom_Rectangle_toString = {MEMBER_METHOD, 0x01, "toString", &_String, &flash_geom_Rectangle};
static memberinfo_t flash_geom_Rectangle_intersects = {MEMBER_METHOD, 0x01, "intersects", &_Boolean, &flash_geom_Rectangle};
static memberinfo_t flash_geom_Rectangle_topLeft = {MEMBER_SLOT, 0x01, "topLeft", 0, &flash_geom_Rectangle};
...
static memberinfo_t flash_media_Camera_loopback = {MEMBER_SLOT, 0x01, "loopback", 0, &flash_media_Camera};
static memberinfo_t flash_media_Camera_setLoopback = {MEMBER_METHOD, 0x01, "setLoopback", 0, &flash_media_Camera};
static memberinfo_t flash_media_Camera_width = {MEMBER_SLOT, 0x01, "width", 0, &flash_media_Camera};
static memberinfo_t flash_media_Camera_setCursor = {MEMBER_METHOD, 0x01, "setCursor", 0, &flash_media_Camera};
static memberinfo_t flash_media_Camera_name = {MEMBER_SLOT, 0x01, "name", 0, &flash_media_Camera};
static memberinfo_t flash_media_Camera_setMode = {MEMBER_METHOD, 0x01, "setMode", 0, &flash_media_Camera};
static memberinfo_t flash_media_Camera_height = {MEMBER_SLOT, 0x01, "height", 0, &flash_media_Camera};
static memberinfo_t flash_media_Camera_fps = {MEMBER_SLOT, 0x01, "fps", 0, &flash_media_Camera};
static memberinfo_t flash_media_Camera_muted = {MEMBER_SLOT, 0x01, "muted", 0, &flash_media_Camera};
static memberinfo_t flash_media_Camera_motionLevel = {MEMBER_SLOT, 0x01, "motionLevel", 0, &flash_media_Camera};
static memberinfo_t flash_media_Camera_currentFPS = {MEMBER_SLOT, 0x01, "currentFPS", 0, &flash_media_Camera};
static memberinfo_t flash_media_Camera_bandwidth = {MEMBER_SLOT, 0x01, "bandwidth", 0, &flash_media_Camera};
static memberinfo_t flash_media_Camera_keyFrameInterval = {MEMBER_SLOT, 0x01, "keyFrameInterval", 0, &flash_media_Camera};
static memberinfo_t flash_media_Camera_activityLevel = {MEMBER_SLOT, 0x01, "activityLevel", 0, &flash_media_Camera};
...
static memberinfo_t flash_media_ID3Info_track = {MEMBER_SLOT, 0x01, "track", 0, &flash_media_ID3Info};
...
static memberinfo_t flash_media_Microphone_index = {MEMBER_SLOT, 0x01, "index", 0, &flash_media_Microphone};
static memberinfo_t flash_media_Microphone_useEchoSuppression = {MEMBER_SLOT, 0x01, "useEchoSuppression", 0, &flash_media_Microphone};
static memberinfo_t flash_media_Microphone_soundTransform = {MEMBER_SLOT, 0x01, "soundTransform", 0, &flash_media_Microphone};
static memberinfo_t flash_media_Microphone_silenceTimeout = {MEMBER_SLOT, 0x01, "silenceTimeout", 0, &flash_media_Microphone};
static memberinfo_t flash_media_Microphone_silenceLevel = {MEMBER_SLOT, 0x01, "silenceLevel", 0, &flash_media_Microphone};
static memberinfo_t flash_media_Microphone_setSilenceLevel = {MEMBER_METHOD, 0x01, "setSilenceLevel", 0, &flash_media_Microphone};
static memberinfo_t flash_media_Microphone_muted = {MEMBER_SLOT, 0x01, "muted", 0, &flash_media_Microphone};
...
static memberinfo_t flash_media_Sound_load = {MEMBER_METHOD, 0x01, "load", 0, &flash_media_Sound};
static memberinfo_t flash_media_Sound_url = {MEMBER_SLOT, 0x01, "url", 0, &flash_media_Sound};
static memberinfo_t flash_media_Sound_play = {MEMBER_METHOD, 0x01, "play", &flash_media_SoundChannel, &flash_media_Sound};
...
static memberinfo_t flash_media_Video_smoothing = {MEMBER_SLOT, 0x01, "smoothing", 0, &flash_media_Video};
...
static memberinfo_t flash_net_FileReference_type = {MEMBER_SLOT, 0x01, "type", 0, &flash_net_FileReference};
static memberinfo_t flash_net_FileReference_name = {MEMBER_SLOT, 0x01, "name", 0, &flash_net_FileReference};
static memberinfo_t flash_net_FileReference_upload = {MEMBER_METHOD, 0x01, "upload", 0, &flash_net_FileReference};
static memberinfo_t flash_net_FileReference_cancel = {MEMBER_METHOD, 0x01, "cancel", 0, &flash_net_FileReference};
...
static memberinfo_t flash_net_LocalConnection_client = {MEMBER_SLOT, 0x01, "client", 0, &flash_net_LocalConnection};
...
static memberinfo_t flash_net_NetConnection_addHeader = {MEMBER_METHOD, 0x01, "addHeader", 0, &flash_net_NetConnection};
static memberinfo_t flash_net_NetConnection_usingTLS = {MEMBER_SLOT, 0x01, "usingTLS", 0, &flash_net_NetConnection};
static memberinfo_t flash_net_NetConnection_call = {MEMBER_METHOD, 0x01, "call", 0, &flash_net_NetConnection};
static memberinfo_t flash_net_NetConnection_objectEncoding = {MEMBER_SLOT, 0x01, "objectEncoding", 0, &flash_net_NetConnection};
static memberinfo_t flash_net_NetConnection_connect = {MEMBER_METHOD, 0x01, "connect", 0, &flash_net_NetConnection};
...
static memberinfo_t flash_net_NetStream_attachAudio = {MEMBER_METHOD, 0x01, "attachAudio", 0, &flash_net_NetStream};
static memberinfo_t flash_net_NetStream_publish = {MEMBER_METHOD, 0x01, "publish", 0, &flash_net_NetStream};
static memberinfo_t flash_net_NetStream_bytesTotal = {MEMBER_SLOT, 0x01, "bytesTotal", 0, &flash_net_NetStream};
static memberinfo_t flash_net_NetStream_soundTransform = {MEMBER_SLOT, 0x01, "soundTransform", 0, &flash_net_NetStream};
static memberinfo_t flash_net_NetStream_client = {MEMBER_SLOT, 0x01, "client", 0, &flash_net_NetStream};
static memberinfo_t flash_net_NetStream_bufferTime = {MEMBER_SLOT, 0x01, "bufferTime", 0, &flash_net_NetStream};
static memberinfo_t flash_net_NetStream_currentFPS = {MEMBER_SLOT, 0x01, "currentFPS", 0, &flash_net_NetStream};
static memberinfo_t flash_net_NetStream_objectEncoding = {MEMBER_SLOT, 0x01, "objectEncoding", 0, &flash_net_NetStream};
static memberinfo_t flash_net_NetStream_play = {MEMBER_METHOD, 0x01, "play", 0, &flash_net_NetStream};
static memberinfo_t flash_net_NetStream_resume = {MEMBER_METHOD, 0x01, "resume", 0, &flash_net_NetStream};
static memberinfo_t flash_net_NetStream_receiveAudio = {MEMBER_METHOD, 0x01, "receiveAudio", 0, &flash_net_NetStream};
static memberinfo_t flash_net_NetStream_bufferLength = {MEMBER_SLOT, 0x01, "bufferLength", 0, &flash_net_NetStream};
static memberinfo_t flash_net_NetStream_bytesLoaded = {MEMBER_SLOT, 0x01, "bytesLoaded", 0, &flash_net_NetStream};
static memberinfo_t flash_net_NetStream_receiveVideo = {MEMBER_METHOD, 0x01, "receiveVideo", 0, &flash_net_NetStream};
static memberinfo_t flash_net_NetStream_attachCamera = {MEMBER_METHOD, 0x01, "attachCamera", 0, &flash_net_NetStream};
static memberinfo_t flash_net_NetStream_videoCodec = {MEMBER_SLOT, 0x01, "videoCodec", 0, &flash_net_NetStream};
static memberinfo_t flash_net_NetStream_audioCodec = {MEMBER_SLOT, 0x01, "audioCodec", 0, &flash_net_NetStream};
static memberinfo_t flash_net_NetStream_time = {MEMBER_SLOT, 0x01, "time", 0, &flash_net_NetStream};
static memberinfo_t flash_net_NetStream_checkPolicyFile = {MEMBER_SLOT, 0x01, "checkPolicyFile", 0, &flash_net_NetStream};
static memberinfo_t flash_net_NetStream_pause = {MEMBER_METHOD, 0x01, "pause", 0, &flash_net_NetStream};
...
static memberinfo_t flash_net_SharedObject_setDirty = {MEMBER_METHOD, 0x01, "setDirty", 0, &flash_net_SharedObject};
static memberinfo_t flash_net_SharedObject_fps = {MEMBER_SLOT, 0x01, "fps", 0, &flash_net_SharedObject};
static memberinfo_t flash_net_SharedObject_clear = {MEMBER_METHOD, 0x01, "clear", 0, &flash_net_SharedObject};
static memberinfo_t flash_net_SharedObject_send = {MEMBER_METHOD, 0x01, "send", 0, &flash_net_SharedObject};
static memberinfo_t flash_net_SharedObject_setProperty = {MEMBER_METHOD, 0x01, "setProperty", 0, &flash_net_SharedObject};
static memberinfo_t flash_net_SharedObject_objectEncoding = {MEMBER_SLOT, 0x01, "objectEncoding", 0, &flash_net_SharedObject};
...
static memberinfo_t flash_net_Socket_writeByte = {MEMBER_METHOD, 0x01, "writeByte", 0, &flash_net_Socket};
static memberinfo_t flash_net_Socket_writeInt = {MEMBER_METHOD, 0x01, "writeInt", 0, &flash_net_Socket};
static memberinfo_t flash_net_Socket_readShort = {MEMBER_METHOD, 0x01, "readShort", &_int, &flash_net_Socket};
static memberinfo_t flash_net_Socket_readUnsignedShort = {MEMBER_METHOD, 0x01, "readUnsignedShort", &_uint, &flash_net_Socket};
static memberinfo_t flash_net_Socket_endian = {MEMBER_SLOT, 0x01, "endian", 0, &flash_net_Socket};
static memberinfo_t flash_net_Socket_objectEncoding = {MEMBER_SLOT, 0x01, "objectEncoding", 0, &flash_net_Socket};
static memberinfo_t flash_net_Socket_writeDouble = {MEMBER_METHOD, 0x01, "writeDouble", 0, &flash_net_Socket};
static memberinfo_t flash_net_Socket_readObject = {MEMBER_METHOD, 0x01, "readObject", 0, &flash_net_Socket};
static memberinfo_t flash_net_Socket_bytesAvailable = {MEMBER_SLOT, 0x01, "bytesAvailable", 0, &flash_net_Socket};
static memberinfo_t flash_net_Socket_readDouble = {MEMBER_METHOD, 0x01, "readDouble", &_Number, &flash_net_Socket};
static memberinfo_t flash_net_Socket_readUTF = {MEMBER_METHOD, 0x01, "readUTF", &_String, &flash_net_Socket};
static memberinfo_t flash_net_Socket_readBoolean = {MEMBER_METHOD, 0x01, "readBoolean", &_Boolean, &flash_net_Socket};
static memberinfo_t flash_net_Socket_readUTFBytes = {MEMBER_METHOD, 0x01, "readUTFBytes", &_String, &flash_net_Socket};
static memberinfo_t flash_net_Socket_writeMultiByte = {MEMBER_METHOD, 0x01, "writeMultiByte", 0, &flash_net_Socket};
static memberinfo_t flash_net_Socket_writeFloat = {MEMBER_METHOD, 0x01, "writeFloat", 0, &flash_net_Socket};
static memberinfo_t flash_net_Socket_readByte = {MEMBER_METHOD, 0x01, "readByte", &_int, &flash_net_Socket};
static memberinfo_t flash_net_Socket_writeUTF = {MEMBER_METHOD, 0x01, "writeUTF", 0, &flash_net_Socket};
static memberinfo_t flash_net_Socket_writeBoolean = {MEMBER_METHOD, 0x01, "writeBoolean", 0, &flash_net_Socket};
static memberinfo_t flash_net_Socket_readUnsignedInt = {MEMBER_METHOD, 0x01, "readUnsignedInt", &_uint, &flash_net_Socket};
static memberinfo_t flash_net_Socket_writeBytes = {MEMBER_METHOD, 0x01, "writeBytes", 0, &flash_net_Socket};
static memberinfo_t flash_net_Socket_readUnsignedByte = {MEMBER_METHOD, 0x01, "readUnsignedByte", &_uint, &flash_net_Socket};
static memberinfo_t flash_net_Socket_writeUnsignedInt = {MEMBER_METHOD, 0x01, "writeUnsignedInt", 0, &flash_net_Socket};
static memberinfo_t flash_net_Socket_writeShort = {MEMBER_METHOD, 0x01, "writeShort", 0, &flash_net_Socket};
static memberinfo_t flash_net_Socket_readFloat = {MEMBER_METHOD, 0x01, "readFloat", &_Number, &flash_net_Socket};
static memberinfo_t flash_net_Socket_connect = {MEMBER_METHOD, 0x01, "connect", 0, &flash_net_Socket};
static memberinfo_t flash_net_Socket_readMultiByte = {MEMBER_METHOD, 0x01, "readMultiByte", &_String, &flash_net_Socket};
static memberinfo_t flash_net_Socket_close = {MEMBER_METHOD, 0x01, "close", 0, &flash_net_Socket};
...
static memberinfo_t flash_net_URLStream_readDouble = {MEMBER_METHOD, 0x01, "readDouble", &_Number, &flash_net_URLStream};
static memberinfo_t flash_net_URLStream_readUnsignedShort = {MEMBER_METHOD, 0x01, "readUnsignedShort", &_uint, &flash_net_URLStream};
static memberinfo_t flash_net_URLStream_endian = {MEMBER_SLOT, 0x01, "endian", 0, &flash_net_URLStream};
static memberinfo_t flash_net_URLStream_bytesAvailable = {MEMBER_SLOT, 0x01, "bytesAvailable", 0, &flash_net_URLStream};
static memberinfo_t flash_net_URLStream_readUTF = {MEMBER_METHOD, 0x01, "readUTF", &_String, &flash_net_URLStream};
static memberinfo_t flash_net_URLStream_objectEncoding = {MEMBER_SLOT, 0x01, "objectEncoding", 0, &flash_net_URLStream};
static memberinfo_t flash_net_URLStream_readBoolean = {MEMBER_METHOD, 0x01, "readBoolean", &_Boolean, &flash_net_URLStream};
static memberinfo_t flash_net_URLStream_readUTFBytes = {MEMBER_METHOD, 0x01, "readUTFBytes", &_String, &flash_net_URLStream};
static memberinfo_t flash_net_URLStream_readByte = {MEMBER_METHOD, 0x01, "readByte", &_int, &flash_net_URLStream};
static memberinfo_t flash_net_URLStream_readUnsignedInt = {MEMBER_METHOD, 0x01, "readUnsignedInt", &_uint, &flash_net_URLStream};
static memberinfo_t flash_net_URLStream_readUnsignedByte = {MEMBER_METHOD, 0x01, "readUnsignedByte", &_uint, &flash_net_URLStream};
static memberinfo_t flash_net_URLStream_load = {MEMBER_METHOD, 0x01, "load", 0, &flash_net_URLStream};
static memberinfo_t flash_net_URLStream_readMultiByte = {MEMBER_METHOD, 0x01, "readMultiByte", &_String, &flash_net_URLStream};
static memberinfo_t flash_net_URLStream_readObject = {MEMBER_METHOD, 0x01, "readObject", 0, &flash_net_URLStream};
...
static memberinfo_t flash_printing_PrintJob_pageHeight = {MEMBER_SLOT, 0x01, "pageHeight", 0, &flash_printing_PrintJob};
static memberinfo_t flash_printing_PrintJob_paperWidth = {MEMBER_SLOT, 0x01, "paperWidth", 0, &flash_printing_PrintJob};
...
static memberinfo_t flash_text_TextField_caretIndex = {MEMBER_SLOT, 0x01, "caretIndex", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_maxScrollV = {MEMBER_SLOT, 0x01, "maxScrollV", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_getImageReference = {MEMBER_METHOD, 0x01, "getImageReference", &flash_display_DisplayObject, &flash_text_TextField};
static memberinfo_t flash_text_TextField_scrollV = {MEMBER_SLOT, 0x01, "scrollV", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_border = {MEMBER_SLOT, 0x01, "border", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_text = {MEMBER_SLOT, 0x01, "text", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_background = {MEMBER_SLOT, 0x01, "background", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_getCharBoundaries = {MEMBER_METHOD, 0x01, "getCharBoundaries", &flash_geom_Rectangle, &flash_text_TextField};
static memberinfo_t flash_text_TextField_borderColor = {MEMBER_SLOT, 0x01, "borderColor", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_getFirstCharInParagraph = {MEMBER_METHOD, 0x01, "getFirstCharInParagraph", &_int, &flash_text_TextField};
static memberinfo_t flash_text_TextField_type = {MEMBER_SLOT, 0x01, "type", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_replaceSelectedText = {MEMBER_METHOD, 0x01, "replaceSelectedText", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_getRawText = {MEMBER_METHOD, 0x01, "getRawText", &_String, &flash_text_TextField};
static memberinfo_t flash_text_TextField_alwaysShowSelection = {MEMBER_SLOT, 0x01, "alwaysShowSelection", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_sharpness = {MEMBER_SLOT, 0x01, "sharpness", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_textColor = {MEMBER_SLOT, 0x01, "textColor", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_defaultTextFormat = {MEMBER_SLOT, 0x01, "defaultTextFormat", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_condenseWhite = {MEMBER_SLOT, 0x01, "condenseWhite", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_autoSize = {MEMBER_SLOT, 0x01, "autoSize", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_styleSheet = {MEMBER_SLOT, 0x01, "styleSheet", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_embedFonts = {MEMBER_SLOT, 0x01, "embedFonts", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_displayAsPassword = {MEMBER_SLOT, 0x01, "displayAsPassword", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_antiAliasType = {MEMBER_SLOT, 0x01, "antiAliasType", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_multiline = {MEMBER_SLOT, 0x01, "multiline", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_selectionEndIndex = {MEMBER_SLOT, 0x01, "selectionEndIndex", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_mouseWheelEnabled = {MEMBER_SLOT, 0x01, "mouseWheelEnabled", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_selectedText = {MEMBER_SLOT, 0x01, "selectedText", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_thickness = {MEMBER_SLOT, 0x01, "thickness", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_getLineIndexAtPoint = {MEMBER_METHOD, 0x01, "getLineIndexAtPoint", &_int, &flash_text_TextField};
static memberinfo_t flash_text_TextField_appendText = {MEMBER_METHOD, 0x01, "appendText", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_selectionBeginIndex = {MEMBER_SLOT, 0x01, "selectionBeginIndex", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_bottomScrollV = {MEMBER_SLOT, 0x01, "bottomScrollV", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_htmlText = {MEMBER_SLOT, 0x01, "htmlText", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_selectable = {MEMBER_SLOT, 0x01, "selectable", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_getLineIndexOfChar = {MEMBER_METHOD, 0x01, "getLineIndexOfChar", &_int, &flash_text_TextField};
static memberinfo_t flash_text_TextField_restrict = {MEMBER_SLOT, 0x01, "restrict", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_gridFitType = {MEMBER_SLOT, 0x01, "gridFitType", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_setSelection = {MEMBER_METHOD, 0x01, "setSelection", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_getTextFormat = {MEMBER_METHOD, 0x01, "getTextFormat", &flash_text_TextFormat, &flash_text_TextField};
static memberinfo_t flash_text_TextField_setTextFormat = {MEMBER_METHOD, 0x01, "setTextFormat", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_textWidth = {MEMBER_SLOT, 0x01, "textWidth", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_getTextRuns = {MEMBER_METHOD, 0x01, "getTextRuns", &_Array, &flash_text_TextField};
static memberinfo_t flash_text_TextField_getLineOffset = {MEMBER_METHOD, 0x01, "getLineOffset", &_int, &flash_text_TextField};
static memberinfo_t flash_text_TextField_wordWrap = {MEMBER_SLOT, 0x01, "wordWrap", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_useRichTextClipboard = {MEMBER_SLOT, 0x01, "useRichTextClipboard", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_backgroundColor = {MEMBER_SLOT, 0x01, "backgroundColor", 0, &flash_text_TextField};
static memberinfo_t flash_text_TextField_textHeight = {MEMBER_SLOT, 0x01, "textHeight", 0, &flash_text_TextField};
...
static memberinfo_t flash_text_TextFormat_size = {MEMBER_SLOT, 0x01, "size", 0, &flash_text_TextFormat};
static memberinfo_t flash_text_TextFormat_display = {MEMBER_SLOT, 0x01, "display", 0, &flash_text_TextFormat};
static memberinfo_t flash_text_TextFormat_bold = {MEMBER_SLOT, 0x01, "bold", 0, &flash_text_TextFormat};
static memberinfo_t flash_text_TextFormat_leading = {MEMBER_SLOT, 0x01, "leading", 0, &flash_text_TextFormat};
static memberinfo_t flash_text_TextFormat_rightMargin = {MEMBER_SLOT, 0x01, "rightMargin", 0, &flash_text_TextFormat};
static memberinfo_t flash_text_TextFormat_leftMargin = {MEMBER_SLOT, 0x01, "leftMargin", 0, &flash_text_TextFormat};
static memberinfo_t flash_text_TextFormat_font = {MEMBER_SLOT, 0x01, "font", 0, &flash_text_TextFormat};
static memberinfo_t flash_text_TextFormat_indent = {MEMBER_SLOT, 0x01, "indent", 0, &flash_text_TextFormat};
static memberinfo_t flash_text_TextFormat_blockIndent = {MEMBER_SLOT, 0x01, "blockIndent", 0, &flash_text_TextFormat};
static memberinfo_t flash_text_TextFormat_kerning = {MEMBER_SLOT, 0x01, "kerning", 0, &flash_text_TextFormat};
static memberinfo_t flash_text_TextFormat_tabStops = {MEMBER_SLOT, 0x01, "tabStops", 0, &flash_text_TextFormat};
static memberinfo_t flash_text_TextFormat_italic = {MEMBER_SLOT, 0x01, "italic", 0, &flash_text_TextFormat};
static memberinfo_t flash_text_TextFormat_target = {MEMBER_SLOT, 0x01, "target", 0, &flash_text_TextFormat};
...
static memberinfo_t flash_text_TextSnapshot_getSelected = {MEMBER_METHOD, 0x01, "getSelected", &_Boolean, &flash_text_TextSnapshot};
static memberinfo_t flash_text_TextSnapshot_getTextRunInfo = {MEMBER_METHOD, 0x01, "getTextRunInfo", &_Array, &flash_text_TextSnapshot};
static memberinfo_t flash_text_TextSnapshot_charCount = {MEMBER_SLOT, 0x01, "charCount", 0, &flash_text_TextSnapshot};
...
static memberinfo_t flash_ui_ContextMenuBuiltInItems_zoom = {MEMBER_SLOT, 0x01, "zoom", 0, &flash_ui_ContextMenuBuiltInItems};
static memberinfo_t flash_ui_ContextMenuBuiltInItems_play = {MEMBER_SLOT, 0x01, "play", 0, &flash_ui_ContextMenuBuiltInItems};
static memberinfo_t flash_ui_ContextMenuBuiltInItems_forwardAndBack = {MEMBER_SLOT, 0x01, "forwardAndBack", 0, &flash_ui_ContextMenuBuiltInItems};
...
static memberinfo_t flash_utils_ByteArray_readShort = {MEMBER_METHOD, 0x01, "readShort", &_int, &flash_utils_ByteArray};
static memberinfo_t flash_utils_ByteArray_writeDouble = {MEMBER_METHOD, 0x01, "writeDouble", 0, &flash_utils_ByteArray};
static memberinfo_t flash_utils_ByteArray_writeByte = {MEMBER_METHOD, 0x01, "writeByte", 0, &flash_utils_ByteArray};
static memberinfo_t flash_utils_ByteArray_readUnsignedShort = {MEMBER_METHOD, 0x01, "readUnsignedShort", &_uint, &flash_utils_ByteArray};
static memberinfo_t flash_utils_ByteArray_endian = {MEMBER_SLOT, 0x01, "endian", 0, &flash_utils_ByteArray};
static memberinfo_t flash_utils_ByteArray_bytesAvailable = {MEMBER_SLOT, 0x01, "bytesAvailable", 0, &flash_utils_ByteArray};
static memberinfo_t flash_utils_ByteArray_writeInt = {MEMBER_METHOD, 0x01, "writeInt", 0, &flash_utils_ByteArray};
static memberinfo_t flash_utils_ByteArray_position = {MEMBER_SLOT, 0x01, "position", 0, &flash_utils_ByteArray};
static memberinfo_t flash_utils_ByteArray_readBoolean = {MEMBER_METHOD, 0x01, "readBoolean", &_Boolean, &flash_utils_ByteArray};
static memberinfo_t flash_utils_ByteArray_readDouble = {MEMBER_METHOD, 0x01, "readDouble", &_Number, &flash_utils_ByteArray};
static memberinfo_t flash_utils_ByteArray_readUTF = {MEMBER_METHOD, 0x01, "readUTF", &_String, &flash_utils_ByteArray};
static memberinfo_t flash_utils_ByteArray_readUTFBytes = {MEMBER_METHOD, 0x01, "readUTFBytes", &_String, &flash_utils_ByteArray};
static memberinfo_t flash_utils_ByteArray_readUnsignedInt = {MEMBER_METHOD, 0x01, "readUnsignedInt", &_uint, &flash_utils_ByteArray};
static memberinfo_t flash_utils_ByteArray_readByte = {MEMBER_METHOD, 0x01, "readByte", &_int, &flash_utils_ByteArray};
static memberinfo_t flash_utils_ByteArray_writeUTF = {MEMBER_METHOD, 0x01, "writeUTF", 0, &flash_utils_ByteArray};
static memberinfo_t flash_utils_ByteArray_objectEncoding = {MEMBER_SLOT, 0x01, "objectEncoding", 0, &flash_utils_ByteArray};
static memberinfo_t flash_utils_ByteArray_writeBoolean = {MEMBER_METHOD, 0x01, "writeBoolean", 0, &flash_utils_ByteArray};
static memberinfo_t flash_utils_ByteArray_writeMultiByte = {MEMBER_METHOD, 0x01, "writeMultiByte", 0, &flash_utils_ByteArray};
static memberinfo_t flash_utils_ByteArray_writeBytes = {MEMBER_METHOD, 0x01, "writeBytes", 0, &flash_utils_ByteArray};
static memberinfo_t flash_utils_ByteArray_writeFloat = {MEMBER_METHOD, 0x01, "writeFloat", 0, &flash_utils_ByteArray};
static memberinfo_t flash_utils_ByteArray_readUnsignedByte = {MEMBER_METHOD, 0x01, "readUnsignedByte", &_uint, &flash_utils_ByteArray};
static memberinfo_t flash_utils_ByteArray_writeUnsignedInt = {MEMBER_METHOD, 0x01, "writeUnsignedInt", 0, &flash_utils_ByteArray};
static memberinfo_t flash_utils_ByteArray_writeShort = {MEMBER_METHOD, 0x01, "writeShort", 0, &flash_utils_ByteArray};
static memberinfo_t flash_utils_ByteArray_compress = {MEMBER_METHOD, 0x01, "compress", 0, &flash_utils_ByteArray};
static memberinfo_t flash_utils_ByteArray_toString = {MEMBER_METHOD, 0x01, "toString", &_String, &flash_utils_ByteArray};
static memberinfo_t flash_utils_ByteArray_readFloat = {MEMBER_METHOD, 0x01, "readFloat", &_Number, &flash_utils_ByteArray};
static memberinfo_t flash_utils_ByteArray_length = {MEMBER_SLOT, 0x01, "length", 0, &flash_utils_ByteArray};
static memberinfo_t flash_utils_ByteArray_readInt = {MEMBER_METHOD, 0x01, "readInt", &_int, &flash_utils_ByteArray};
...
static memberinfo_t flash_utils_IDataInput_objectEncoding = {MEMBER_SLOT, 0x00, "objectEncoding", 0, &flash_utils_IDataInput};
static memberinfo_t flash_utils_IDataInput_readMultiByte = {MEMBER_METHOD, 0x00, "readMultiByte", &_String, &flash_utils_IDataInput};
static memberinfo_t flash_utils_IDataInput_readFloat = {MEMBER_METHOD, 0x00, "readFloat", &_Number, &flash_utils_IDataInput};
static memberinfo_t flash_utils_IDataInput_readDouble = {MEMBER_METHOD, 0x00, "readDouble", &_Number, &flash_utils_IDataInput};
static memberinfo_t flash_utils_IDataInput_readUnsignedShort = {MEMBER_METHOD, 0x00, "readUnsignedShort", &_uint, &flash_utils_IDataInput};
static memberinfo_t flash_utils_IDataInput_readBoolean = {MEMBER_METHOD, 0x00, "readBoolean", &_Boolean, &flash_utils_IDataInput};
static memberinfo_t flash_utils_IDataInput_readUnsignedByte = {MEMBER_METHOD, 0x00, "readUnsignedByte", &_uint, &flash_utils_IDataInput};
static memberinfo_t flash_utils_IDataInput_readBytes = {MEMBER_METHOD, 0x00, "readBytes", 0, &flash_utils_IDataInput};
static memberinfo_t flash_utils_IDataInput_endian = {MEMBER_SLOT, 0x00, "endian", 0, &flash_utils_IDataInput};
static memberinfo_t flash_utils_IDataInput_readUTF = {MEMBER_METHOD, 0x00, "readUTF", &_String, &flash_utils_IDataInput};
static memberinfo_t flash_utils_IDataInput_readInt = {MEMBER_METHOD, 0x00, "readInt", &_int, &flash_utils_IDataInput};
...
static memberinfo_t flash_utils_IDataOutput_writeByte = {MEMBER_METHOD, 0x00, "writeByte", 0, &flash_utils_IDataOutput};
static memberinfo_t flash_utils_IDataOutput_writeUTF = {MEMBER_METHOD, 0x00, "writeUTF", 0, &flash_utils_IDataOutput};
static memberinfo_t flash_utils_IDataOutput_writeBoolean = {MEMBER_METHOD, 0x00, "writeBoolean", 0, &flash_utils_IDataOutput};
static memberinfo_t flash_utils_IDataOutput_endian = {MEMBER_SLOT, 0x00, "endian", 0, &flash_utils_IDataOutput};
static memberinfo_t flash_utils_IDataOutput_objectEncoding = {MEMBER_SLOT, 0x00, "objectEncoding", 0, &flash_utils_IDataOutput};
static memberinfo_t flash_utils_IDataOutput_writeBytes = {MEMBER_METHOD, 0x00, "writeBytes", 0, &flash_utils_IDataOutput};
static memberinfo_t flash_utils_IDataOutput_writeInt = {MEMBER_METHOD, 0x00, "writeInt", 0, &flash_utils_IDataOutput};
static memberinfo_t flash_utils_IDataOutput_writeDouble = {MEMBER_METHOD, 0x00, "writeDouble", 0, &flash_utils_IDataOutput};
...
static memberinfo_t flash_utils_Proxy_getProperty = {MEMBER_METHOD, 0x00, "getProperty", 0, &flash_utils_Proxy};
static memberinfo_t flash_utils_Proxy_hasProperty = {MEMBER_METHOD, 0x00, "hasProperty", &_Boolean, &flash_utils_Proxy};
static memberinfo_t flash_utils_Proxy_isAttribute = {MEMBER_METHOD, 0x00, "isAttribute", &_Boolean, &flash_utils_Proxy};
static memberinfo_t flash_utils_Proxy_callProperty = {MEMBER_METHOD, 0x00, "callProperty", 0, &flash_utils_Proxy};
...
static memberinfo_t flash_utils_Timer_reset = {MEMBER_METHOD, 0x01, "reset", 0, &flash_utils_Timer};
...
static memberinfo_t flash_xml_XMLDocument_docTypeDecl = {MEMBER_SLOT, 0x01, "docTypeDecl", 0, &flash_xml_XMLDocument};
static memberinfo_t flash_xml_XMLDocument_parseXML = {MEMBER_METHOD, 0x01, "parseXML", 0, &flash_xml_XMLDocument};
...
static memberinfo_t flash_xml_XMLNode_namespaceURI = {MEMBER_SLOT, 0x01, "namespaceURI", 0, &flash_xml_XMLNode};
static memberinfo_t flash_xml_XMLNode_prefix = {MEMBER_SLOT, 0x01, "prefix", 0, &flash_xml_XMLNode};
static memberinfo_t flash_xml_XMLNode_firstChild = {MEMBER_SLOT, 0x01, "firstChild", 0, &flash_xml_XMLNode};
static memberinfo_t flash_xml_XMLNode_nextSibling = {MEMBER_SLOT, 0x01, "nextSibling", 0, &flash_xml_XMLNode};
static memberinfo_t flash_xml_XMLNode_attributes = {MEMBER_SLOT, 0x01, "attributes", 0, &flash_xml_XMLNode};
static memberinfo_t flash_xml_XMLNode_nodeType = {MEMBER_SLOT, 0x01, "nodeType", 0, &flash_xml_XMLNode};
static memberinfo_t flash_xml_XMLNode_appendChild = {MEMBER_METHOD, 0x01, "appendChild", 0, &flash_xml_XMLNode};
static memberinfo_t flash_xml_XMLNode_lastChild = {MEMBER_SLOT, 0x01, "lastChild", 0, &flash_xml_XMLNode};
static memberinfo_t flash_xml_XMLNode_insertBefore = {MEMBER_METHOD, 0x01, "insertBefore", 0, &flash_xml_XMLNode};
static memberinfo_t flash_xml_XMLNode_getNamespaceForPrefix = {MEMBER_METHOD, 0x01, "getNamespaceForPrefix", &_String, &flash_xml_XMLNode};
static memberinfo_t flash_xml_XMLNode_nodeName = {MEMBER_SLOT, 0x01, "nodeName", 0, &flash_xml_XMLNode};
static memberinfo_t flash_xml_XMLNode_hasChildNodes = {MEMBER_METHOD, 0x01, "hasChildNodes", &_Boolean, &flash_xml_XMLNode};
static memberinfo_t flash_xml_XMLNode_childNodes = {MEMBER_SLOT, 0x01, "childNodes", 0, &flash_xml_XMLNode};
static memberinfo_t flash_xml_XMLNode_localName = {MEMBER_SLOT, 0x01, "localName", 0, &flash_xml_XMLNode};
static memberinfo_t flash_xml_XMLNode_getPrefixForNamespace = {MEMBER_METHOD, 0x01, "getPrefixForNamespace", &_String, &flash_xml_XMLNode};
